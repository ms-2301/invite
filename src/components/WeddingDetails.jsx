            ...
            >
              <div className={`grid md:grid-cols-2 gap-8 items-center ${index % 2 === 0 ? "" : "md:flex-row-reverse"}`}>
                <div className={`relative ${index % 2 === 0 ? "md:order-1" : "md:order-2"}`}>
                  <div className="relative bg-gray-800/50 backdrop-blur-sm border border-rose-200/20 rounded-lg overflow-hidden aspect-video group-hover:border-rose-300/50 transition-all duration-300">
                    <div className="absolute inset-0 bg-gradient-to-br from-rose-500/15 to-amber-200/15 flex items-center justify-center">
                      <div className="text-center p-8">
                        <div className="w-20 h-20 mx-auto mb-4 rounded-lg bg-gradient-to-br from-rose-400 to-amber-200 flex items-center justify-center text-3xl font-bold text-rose-950">
                          <FaHeart />
                        </div>
                        <p className="text-rose-50 text-sm">{moment.title}</p>
                      </div>
                    </div>
                  </div>
                </div>
